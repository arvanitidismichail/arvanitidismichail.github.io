...
Αποκατάστασης Ακριβείας για τον Πόνο στη Σπονδυλική Στήλη (CPR Spine), Σχολή Αθλητισμού,
...
διαστημική πτήση, με στόχο τη βελτίωση της υγείας των αστροναυτών σε μελλοντικές αποστολές.
Τα κύρια
